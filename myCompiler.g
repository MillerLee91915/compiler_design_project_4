...
if_then_stmt
            : IF '(' cond_expression ')' {TextCode.add("Ltrue:");} block_stmt {TextCode.add("br label \%Lend");}
            ;


if_else_stmt
            : ELSE {TextCode.add("Lfalse:");} block_stmt {TextCode.add("br label \%Lend");}
            |
            ;
...
print_func
               : PRINTF '(' a=STRING_LITERAL ',' b=primaryExpr  ')'
                  {
                     int strlen = $a.text.length();
                     TextCode.add(0,"@.str = private unnamed_addr constant [4 x i8] c\"\%d\\0A\\00\"");
                     TextCode.add("\%t" + varCount + " = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([" + strlen + " x i8], ["+strlen+" x i8]* @.str, i64 0, i64 0), i32 \%t"+ $b.theInfo.theVar.varIndex +")");
					      varCount ++;
                  }
                   ;
                  ...
                  ( '>' b=arith_expression
                    {
                       ...
                       if (($a.theInfo.theType == Type.INT) &&
                           ...
                           TextCode.add("br i1 \%t" + varCount + ", label \%Ltrue, label \%Lfalse");
                           ...
                           TextCode.add("\%t" + varCount + " = icmp sgt i32 \%t" + $theInfo.theVar.varIndex + ", 0" );
                           TextCode.add("br i1 \%t" + varCount + ", label \%Ltrue, label \%Lfalse");
